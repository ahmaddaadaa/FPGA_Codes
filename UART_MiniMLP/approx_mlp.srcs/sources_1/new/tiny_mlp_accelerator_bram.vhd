...
architecture rtl of tiny_mlp_accelerator_bram is
    ...
    type hidden_t is array (0 to NUM_HIDDEN - 1) of signed(7 downto 0);
    signal hidden : hidden_t := (others => (others => '0'));

    signal out0_reg : signed(31 downto 0) := (others => '0');
    signal out1_reg : signed(31 downto 0) := (others => '0');
    ...
    constant HIDDEN_SCALE_SHIFT : integer := 0;

    function relu_clip_s8(x : signed(31 downto 0)) return signed is
        variable y : signed(31 downto 0);
    begin
        if x < to_signed(0, 32) then
            return to_signed(0, 8);
        else
            y := shift_right(x, HIDDEN_SCALE_SHIFT);
            ...
            if rst = '1' then
                ...
                case state is
                    ...
                    when INIT_L1_SET_BIAS =>
                        bias_raddr <= to_unsigned(hidden_idx, BIAS_ADDR_WIDTH);
                    ...
                    when SET_ADDR_L1 =>
                        ...
                        waddr_int := hidden_idx * NUM_INPUTS + input_idx;
                    ...
                    when STORE_HIDDEN =>
                        hidden(hidden_idx) <= relu_clip_s8(acc);
                    ...
                    when INIT_L2_SET_BIAS =>
                        bias_raddr <= to_unsigned(NUM_HIDDEN + output_idx, BIAS_ADDR_WIDTH);
                    ...
                    when SET_ADDR_L2 =>
                        waddr_int := NUM_INPUTS * NUM_HIDDEN
