...
set "MANIFEST=%ROOT%models\vakili\manifest.json"
...
if errorlevel 1 exit /b %ERRORLEVEL%
"%PYTHON%" "%VERIFY%" --arithmetic vakili-r1 --manifest "%MANIFEST%" --dataset official-test --sample-count 10000 --progress-every 100 --show-confusion --mnist-download %*
exit /b %ERRORLEVEL%
